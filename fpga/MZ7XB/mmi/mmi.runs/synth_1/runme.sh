...
HD_PWD='D:/fpgawork/mmi/mmi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ecat_tb_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ecat_tb_wrapper.tcl
