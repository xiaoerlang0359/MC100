...
HD_PWD='D:/fpgawork/mmi/mmi.runs/mii_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mii_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mii_xbar_0.tcl
