...
HD_PWD='D:/fpgawork/mmi/mmi.runs/mii_esi_arbt_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mii_esi_arbt_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mii_esi_arbt_0_0.tcl
