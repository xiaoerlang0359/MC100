...
HD_PWD='D:/fpgawork/mmi/mmi.runs/ecat_tb_axi_protocol_convert_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ecat_tb_axi_protocol_convert_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ecat_tb_axi_protocol_convert_0_1.tcl
