...
HD_PWD='D:/fpgawork/mmi/mmi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ecat_tb_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ecat_tb_wrapper.tcl -notrace
