...
HD_PWD='D:/fpgawork/mmi/mmi.runs/ecat_tb_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ecat_tb_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ecat_tb_clk_wiz_0_0.tcl
