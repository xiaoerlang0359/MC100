...
HD_PWD='D:/fpgawork/mmi/mmi.runs/mii_rst_ps7_0_25M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mii_rst_ps7_0_25M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mii_rst_ps7_0_25M_1.tcl
