...
HD_PWD='D:/fpgawork/mmi/mmi.runs/mii_axi_apb_bridge_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mii_axi_apb_bridge_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mii_axi_apb_bridge_1_0.tcl
